...
public class Camera2VideoFragment extends Fragment implements View.OnClickListener {
    ...
    /**
     * An {@link AutoFitTextureVideoView} for camera preview.
     */
    private AutoFitTextureVideoView mTextureView;
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        mTextureView = (AutoFitTextureVideoView) view.findViewById(R.id.texture);
